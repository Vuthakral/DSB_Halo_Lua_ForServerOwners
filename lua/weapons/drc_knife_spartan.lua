...
SWEP.PrintName			= "Spartan IV Knife"
SWEP.InfoName			= "knife"
...
SWEP.ViewModel 		= "models/vuthakral/halo/weapons/c_knife_spartan.mdl"
SWEP.WorldModel 	= "models/vuthakral/halo/weapons/w_knife_spartan.mdl"
